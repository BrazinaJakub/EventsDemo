...
namespace WinFormUI
{
    public partial class Dashboard : Form
    {
        ...
        private void WireUpForm()
        {
            ...
            customer.CheckingAccount.TransactionAproovedEvent += CheckingAccount_TransactionAproovedEvent;
            customer.SavingsAccount.TransactionAproovedEvent += SavingsAccount_TransactionAproovedEvent;
        }

        private void SavingsAccount_TransactionAproovedEvent(object sender, string e)
        {
        ...
        private void CheckingAccount_TransactionAproovedEvent(object sender, string e)
        {
