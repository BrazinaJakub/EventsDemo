...
namespace DemoLibrary
{
    ...
    {
        public event EventHandler<string> TransactionAproovedEvent;
        ...
        public bool AddDeposit(string depositName, decimal amount)
        {
            ...
            Balance += amount;
            TransactionAproovedEvent?.Invoke(this, depositName);
            return true;
        }
        ...
        public bool MakePayment(string paymentName, decimal amount, Account backupAccount = null)
        {
            ...
            if (Balance >= amount)
            {
                ...
                Balance -= amount;
                TransactionAproovedEvent?.Invoke(this, paymentName);
                return true;
            }
            else
            {
